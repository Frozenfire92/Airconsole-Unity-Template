...
var SwipeAnalog = function (el, opts) {
  ...
  this.container = el;
  var noop = function () { };
  this.start_cb = opts.touchstart || noop;
  this.move_cb = opts.touchmove || noop;
  this.end_cb = opts.touchend || noop;
  this.bindEvents();
};
...
SwipeAnalog.prototype = {
  ...
  onTouchMove: function (e) {
    if (this.is_touch_down) {
      this.setEndPosition(e);
      this.move_cb(this.getSwipeVector(e));
    }
    e.preventDefault();
  },
  onTouchEnd: function (e) {
    this.is_touch_down = false;
    this.setEndPosition(e);
    this.end_cb(this.getSwipeVector(e));
    e.preventDefault();
  },
  setStartPosition: function (e) {
    var pos = this.getRelativePos(e);
    this.start_position = { x: pos.x, y: pos.y };
  },
  setEndPosition: function (e) {
    var pos = this.getRelativePos(e);
    this.end_position = { x: pos.x, y: pos.y };
  },
